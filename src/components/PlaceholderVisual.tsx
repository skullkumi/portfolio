  ...
  return (
    <div className="relative flex h-full w-full items-center justify-center overflow-hidden bg-[#06060e]">
      <div
        ...
        style={{
          backgroundImage: `
            linear-gradient(rgba(124,107,255,0.08) 1px, transparent 1px),
      ...
      <div
        ...
        style={{
          backgroundImage: `
            linear-gradient(rgba(255,61,122,0.1) 1px, transparent 1px),
      ...
      <div className="relative z-10 text-center">
        <p className="font-mono text-[10px] uppercase tracking-[0.3em] text-accent-ice/70">
          awaiting capture
        </p>
        ...
        <div className="mx-auto mt-4 flex h-px w-20 overflow-hidden">
          ...
          <div className="h-full w-1/3 bg-accent-violet" />
